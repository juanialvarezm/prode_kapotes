...
export default function PublicGroupsPage() {
  ...
  return (
    <div className="seo-page-container">
      ...
      {/* WhatsApp vs ProdeKapotes Groups */}
      <section className="seo-section">
        <h2 className="seo-section-title">¿Por qué reemplazar el grupo de WhatsApp por ProdeKapotes?</h2>
        <div className="comparison-table-wrapper">
          <table className="comparison-table" aria-label="Comparativa de grupos de WhatsApp frente a ProdeKapotes">
            <thead>
              <tr>
                <th scope="col">Característica</th>
                <th scope="col">Grupo de WhatsApp</th>
                <th scope="col">Grupo en ProdeKapotes</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td><strong>Confirmación de Asistencia</strong></td>
                <td>Mensajes perdidos, audios de 3 minutos y desorden</td>
                <td>Botón de "Confirmar", lista automatizada y suplentes en cola</td>
              </tr>
              <tr>
                <td><strong>Control de Pagos de Cancha</strong></td>
                <td>Planillas manuales o notas que nadie lee</td>
                <td>Registro transparente de quién pagó y quién falta pagar</td>
              </tr>
              <tr>
                <td><strong>Armado de Equipos</strong></td>
                <td>Discusiones interminables y equipos desequilibrados</td>
                <td>Armador inteligente basado en el nivel y estadísticas de cada jugador</td>
              </tr>
              <tr>
                <td><strong>Estadísticas e Historial</strong></td>
                <td>Se olvida a los 2 días quién hizo los goles</td>
                <td>Historial permanente de partidos, goleadores, MVPs y victorias</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      {/* Types of groups */}
      <section className="seo-section">
        <h2 className="seo-section-title">Pensado para todo tipo de equipos</h2>
        <div className="seo-grid-3">
          <article className="seo-card">
            <h3>⚽ Fútbol 5 del Viernes</h3>
            <p>El grupo infaltable para jugar la pichanga o el picadito de fin de semana con amigos de toda la vida.</p>
          </article>
          <article className="seo-card">
            <h3>🏢 Torneos de Empresas y Trabajo</h3>
            <p>Organizá torneos internos entre áreas o departamentos con tabla de posiciones y estadísticas en tiempo real.</p>
          </article>
          <article className="seo-card">
            <h3>🎓 Grupos de Facultad y Exalumnos</h3>
            <p>Mantené vivos los partidos de la camada con historial de enfrentamientos y premios a los mejores jugadores.</p>
          </article>
        </div>
      </section>
